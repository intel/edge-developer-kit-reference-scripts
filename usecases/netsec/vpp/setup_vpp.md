...
#For I226
    ...
    ./dpdk/usertools/dpdk-devbind.py -b uio_pci_generic 02:00.0
#For X710
    modprobe vfio
...
./trex-console
#Change the speed
start -p 0 -f ./stl/IPSEC_1420B_1000f_port0.py  -m 100% --force
start -p 1 -f ./stl/IPSEC_1420B_1000f_port1.py  -m 100% --force

start -p 0 -f ./stl/IPSEC_64B_1000f_port0.py  -m 100% --force
start -p 1 -f ./stl/IPSEC_64B_1000f_port1.py  -m 100% --force
...
#Modify the speed
start -p 0 -f ./stl/VPP_1420B_1000f_port0.py  -m 100% --force
start -p 1 -f ./stl/VPP_1420B_1000f_port1.py  -m 100% --force
tui
```
