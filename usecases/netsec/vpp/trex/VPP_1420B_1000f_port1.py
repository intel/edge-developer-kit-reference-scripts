...
class STLS1(object):
    ...
    def create_stream (self, packet_len):
        ...
        base_pkt = Ether()/IP(src="192.168.0.0",dst="4.0.0.0")/UDP(dport=12,sport=1025)

        pad = max(0, 1420 - len(base_pkt)) * 'x'

        vm = STLVM()

        # create a tuple var
        vm.tuple_var(name = "tuple", ip_min = "2.0.0.0", ip_max = "2.0.3.231", port_min = 1025, port_max = 2048, limit_flows = 10000)
