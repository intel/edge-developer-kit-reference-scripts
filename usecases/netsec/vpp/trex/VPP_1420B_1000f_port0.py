...
class STLS1(object):
    ...
    def create_stream (self, packet_len):
        ...
        base_pkt = Ether()/IP(src="192.168.0.0",dst="8.0.0.0")/UDP(dport=12,sport=1025)
        ...
        # create a tuple var
        vm.tuple_var(name = "tuple", ip_min = "1.0.0.0", ip_max = "1.0.3.231", port_min = 1025, port_max = 2048, limit_flows = 10000)
