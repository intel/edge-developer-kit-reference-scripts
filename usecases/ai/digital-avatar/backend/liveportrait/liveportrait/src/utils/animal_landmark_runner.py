...
class XPoseRunner(object):
    def __init__(self, model_config_path, model_checkpoint_path, embeddings_cache_path=None, cpu_only=False, **kwargs):
        ...
        try:
            with open(f'{embeddings_cache_path}_9.pkl', 'rb') as f: # nosec B301
                self.ins_text_embeddings_9, self.kpt_text_embeddings_9 = pickle.load(f) # nosec B301
            with open(f'{embeddings_cache_path}_68.pkl', 'rb') as f: # nosec B301
                self.ins_text_embeddings_68, self.kpt_text_embeddings_68 = pickle.load(f) # nosec B301
