...
from intel_xpu.xpu_override import xpu_override
xpu_override()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_roll', nargs='+', type=int, default=None, help="the input rnoll degree of the user")
    ...
    parser.add_argument("--verbose",action="store_true", help="saving the intermedia output or ot" ) 
    ...
    if torch.cuda.is_available() and not args.cpu:
        args.device = "cuda"
    if torch.xpu.is_available() and not args.cpu:
        args.device = "xpu"
    else:
        args.device = "cpu"
    print(args.device)
