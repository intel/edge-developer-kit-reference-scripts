...
import torch
import numpy as np
from .attention import scaled_dot_product_attention_32_bit
...
if device_supports_fp64 and os.environ.get('IPEX_FORCE_ATTENTION_SLICE', None) is None:
    print("Device Supports FP64, will use default SDPA from Torch")
...
def scaled_dot_product_attention(query, key, value, attn_mask=None, dropout_p=0.0, is_causal=False, **kwargs):
    ...
    return scaled_dot_product_attention_32_bit(query, key, value, attn_mask=attn_mask, dropout_p=dropout_p, is_causal=is_causal, **kwargs)
